/**
 * Tabler "paw" glyph (filled). Used as the rating marker on hero/details facts.
 * Inherits color via `currentColor` and sizes to the surrounding text (1em) so
 * it aligns with the rating number it sits beside.
 */
